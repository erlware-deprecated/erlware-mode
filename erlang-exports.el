...
;;; Commentary:
;;
;; Runs an erlang source file through the Erlang compiler
;; with the -S option (for 'assembler code') and 'export_all'.
;; We then read that assembler code and parse the export statement.
;; e.g. {exports, [{create_org,0},{module_info,0},{module_info,1}]}.
;; Executing 'erlang-exports' places the full list of functions in an export
;; statement at point.
